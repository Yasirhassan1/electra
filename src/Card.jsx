...
export default function Card({pic, title, id, price, description, catagory}){
    return(
      <Link className='card flex flex-col border border-yellow-600 bg-green-500 justify-between h-full w-full max-w-[300px] rounded-sm hover:shadow-xl transition-all duration-300 hover:scale-105 cursor-pointer' to= "/BuyPage" state={{pic, title, id, price, description, catagory}}> 
