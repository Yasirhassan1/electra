...
export default function SuggestionProducts({pic, title, id, price, description, catagory}){
    return(
       <Link className='container flex flex-col border shadow-lg border-yellow-500 gap-2 bg-white w-full max-w-[200px] rounded-sm p-2' to= "/BuyPage" state={{pic, title, id, price, description, catagory}}>
